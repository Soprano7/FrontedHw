  ...
  return (
      <div id={'hw04'}>
          {currentText ? (
              ...
              <h1 id={'hw04-default-text'}>Здесь появится новое дело</h1> // <-- Была ошибка здесь
          )}

          <Input currentText={currentText} onChange={(e) => setCurrentText(e.target.value)} setCurrentText={setCurrentText}/>
